...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    {{-- Harga Jual --}}
    <div>
        <label for="selling_price" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga Jual (Rp)</label>
    ...
    {{-- Stok Awal --}}
    <div>
        <label for="stock" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Stok Awal</label>
    ...
    {{-- Stok Minimum --}}
    <div>
        <label for="minimum_stock" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Level Stok Minimum</label>
